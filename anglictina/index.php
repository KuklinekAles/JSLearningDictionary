...
<head>
    ...
    <title>Angličtina - Učení slovíček</title>
...
// Získáme textarea element
const notesTextarea = document.createElement('textarea');
notesTextarea.id = 'notes';
notesTextarea.className = 'notes-area';
notesTextarea.rows = 10;
notesTextarea.cols = 50;
notesTextarea.placeholder = 'Zde napište své jazykové poznámky...';
...
// Přidáme textarea do dokumentu
document.body.appendChild(notesTextarea);

// Načteme uložené poznámky při načtení stránky
...
// Ukládáme poznámky při každé změně
